  ...
  return (
    ...
    <div className="w-full h-screen bg-gray-50 flex flex-col">
      <div className="bg-white shadow-sm border-b px-6 py-4">
        <h1 className="text-2xl font-bold text-gray-800">MCD - Système de Transport & Livraison - cloude </h1>
        <p className="text-sm text-gray-600 mt-1">Modèle Conceptuel de Données</p>
      </div>
      
      <div className="flex-1 overflow-auto p-6">
        <div className="bg-white rounded-lg shadow-lg p-8" style={{ transform: `scale(${zoom})`, transformOrigin: 'top left' }}>
          <svg viewBox="0 0 1600 1600" className="w-full" style={{ maxWidth: '1600px' }}>
            <defs>
            ...
            {/* Type Service */}
            <g>
              <rect x="50" y="400" width="180" height="160" fill="#3B82F6" stroke="#1E40AF" strokeWidth="2" rx="8"/>
              ...
              <text x="60" y="535" fill="white" fontSize="13">• tarif_poids</text>
              <text x="60" y="555" fill="white" fontSize="13">• tarif_volume</text>
            </g>

            {/* Expédition */}
            <g>
              <rect x="500" y="400" width="200" height="260" fill="#10B981" stroke="#059669" strokeWidth="2" rx="8"/>
              <text x="600" y="425" textAnchor="middle" fill="white" fontSize="18" fontWeight="bold">EXPEDITION</text>
              <line x1="500" y1="435" x2="700" y2="435" stroke="white" strokeWidth="2"/>
              <text x="510" y="455" fill="white" fontSize="13">• id_expedition</text>
              <text x="510" y="475" fill="white" fontSize="13">• num_expedition</text>
              <text x="510" y="495" fill="white" fontSize="13">• date_création</text>
              ...
              <text x="510" y="575" fill="white" fontSize="13">• montant_total</text>
              <text x="510" y="595" fill="white" fontSize="13">• statut</text>
              <text x="510" y="615" fill="white" fontSize="13">• adresse_enlèvement</text>
            ...
            <g>
              ...
              <text x="980" y="495" fill="white" fontSize="13">• heure_départ</text>
              <text x="980" y="515" fill="white" fontSize="13">• heure_retour</text>
              <text x="980" y="535" fill="white" fontSize="13">• kilométrage</text>
            ...
            <g>
              ...
              <text x="60" y="1155" fill="white" fontSize="13">• date_résolution</text>
            ...
            {/* CONCERNER (Expédition - Type Service) */}
            <line x1="500" y1="530" x2="230" y2="480" stroke="#374151" strokeWidth="2" markerEnd="url(#arrowhead)"/>
            <ellipse cx="365" cy="505" rx="70" ry="30" fill="#FCD34D" stroke="#F59E0B" strokeWidth="2"/>
            <text x="365" y="510" textAnchor="middle" fontSize="14" fontWeight="bold">CONCERNER</text>
            <text x="470" y="525" fontSize="12" fill="#374151">1,n</text>
            <text x="245" y="470" fontSize="12" fill="#374151">1,1</text>
            ...
            <line x1="970" y1="510" x2="700" y2="510" stroke="#374151" strokeWidth="2" markerEnd="url(#arrowhead)"/>
            <ellipse cx="835" cy="510" rx="50" ry="30" fill="#FCD34D" stroke="#F59E0B" strokeWidth="2"/>
            <text x="835" y="515" textAnchor="middle" fontSize="14" fontWeight="bold">INCLURE</text>
            <text x="950" y="505" fontSize="12" fill="#374151">1,1</text>
            <text x="710" y="505" fontSize="12" fill="#374151">0,n</text>
            ...
            <text x="570" y="990" fontSize="12" fill="#374151">1,1</text>
            <text x="610" y="670" fontSize="12" fill="#374151">1,n</text>
