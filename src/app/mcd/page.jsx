  ...
  return (
    <div className="w-full h-screen bg-gray-50 flex flex-col">
      <div className="bg-white shadow-sm border-b px-6 py-4">
        <h1 className="text-2xl font-bold text-gray-800">MCD - Système de Transport & Livraison (corrigé)</h1>
        <p className="text-sm text-gray-600 mt-1">Modèle Conceptuel de Données — tarification & utilisateurs ajoutés</p>
      </div>
